...
function parseCommand(tokens: TokenStream, context: Context): void {
...
function parseCatalog(tokens: TokenStream, context: Context): void {
...
function parseCDTextFile(tokens: TokenStream, context: Context): void {
...
function parseFile(tokens: TokenStream, context: Context): void {
  const {
    state: { parsedCommand },
    options,
  } = context
...
function parseFlags(tokens: TokenStream, context: Context): void {
...
function parseISRC(tokens: TokenStream, context: Context): void {
  const { parsedCommand } = context.state
  if (
    !(parsedCommand & ParsedCommand.TRACK) ||
    parsedCommand & ParsedCommand.INDEX
...
function parsePreGap(tokens: TokenStream, context: Context): void {
  ...
  if (context.state.parsedCommand & ParsedCommand.PREGAP) {
    context.raise(ErrorKind.DuplicatedPreGapCommand, context.state.commandToken)
  }
